...
watch(
  ...
  (newData) => {
    if (newData) {
      ...
      form.gender = newData.patient.gender
      form.birth_date = newData.patient.birth_date
      form.address = newData.patient.address
      form.phones = newData.patient.phone_numbers
      form.social_links = newData.patient.social_links
    }
  },
  { immediate: true }
)
